            ...
            <div id={`parent${props.id}`} className="relative w-8 py-3">
                {onChange ? (
                    <input
                        ...
                        checked={onChecked}
                        onChange={onChange}
                        className="toggle-checkbox absolute block w-5 h-5 rounded-full bg-white dark:bg-gray-700 border-2 dark:border-gray-700 appearance-none cursor-pointer border-gray-50"
                    />
                ) : (
                    <input
                        type="checkbox"
