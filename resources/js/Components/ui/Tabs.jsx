    ...
    return (
        <>
            {model === "vertical" ? (
                <Tab.Group
                    as="div"
                    className={`flex justify-between inline-block${addClass}`}
                >
                    <Tab.List as="ul">
                            ...
                            <Tab as="li" key={index} className="mr-1">
                                {({ selected }) => (
                                    <button
                                        ...
                                        className={
                                            selected
                                                ? "w-full block py-2 px-4 focus:ring-0 focus:outline-none text-center bg-indigo-500 text-gray-100 rounded"
                                                : "w-full block py-2 px-4 focus:ring-0 focus:outline-none bg-white dark:bg-gray-800 text-center text-gray-500"
                                        }
                                    >
                                        {item.title}
                                    </button>
